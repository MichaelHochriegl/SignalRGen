...
internal sealed record HubClientToGenerate(string InterfaceName, string HubName, string HubUri, string InterfaceNamespace, EquatableArray<CacheableMethodDeclaration> ServerToClientMethods, EquatableArray<CacheableUsingDeclaration> Usings)
{
