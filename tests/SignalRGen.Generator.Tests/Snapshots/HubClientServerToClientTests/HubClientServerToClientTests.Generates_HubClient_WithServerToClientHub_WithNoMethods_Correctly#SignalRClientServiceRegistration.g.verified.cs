...
public static class SignalRClientServiceRegistration
{
    ...
    public static SignalRHubServiceCollection WithEmptyNotificationHubClient(this SignalRHubServiceCollection services, Action<HubClientOptions>? configuration = null)
    {
