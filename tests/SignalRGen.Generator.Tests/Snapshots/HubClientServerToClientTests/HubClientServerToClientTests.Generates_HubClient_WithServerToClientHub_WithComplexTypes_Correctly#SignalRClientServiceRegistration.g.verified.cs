...
public static class SignalRClientServiceRegistration
{
    ...
    public static SignalRHubServiceCollection WithComplexNotificationHubClient(this SignalRHubServiceCollection services, Action<HubClientOptions>? configuration = null)
    {
