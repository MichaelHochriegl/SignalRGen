...
public static class SignalRClientServiceRegistration
{
    ...
    public static SignalRHubServiceCollection WithEmptyCommandHubClient(this SignalRHubServiceCollection services, Action<HubClientOptions>? configuration = null)
    {
