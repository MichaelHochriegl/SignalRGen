...
public static class SignalRClientServiceRegistration
{
    ...
    public static SignalRHubServiceCollection WithGenericTestHubClient(this SignalRHubServiceCollection services, Action<HubClientOptions>? configuration = null)
    {
