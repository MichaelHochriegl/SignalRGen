...
public static class SignalRClientServiceRegistration
{
    ...
    public static SignalRHubServiceCollection WithNullableTestHubClient(this SignalRHubServiceCollection services, Action<HubClientOptions>? configuration = null)
    {
