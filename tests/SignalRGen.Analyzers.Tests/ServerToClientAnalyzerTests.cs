...
public class ServerToClientAnalyzerTests
{
    ...
    public async Task ServerToClientInterface_WithComplexGenericTaskReturnType_ShouldTriggerDiagnostic()
    {
        ...
        var expectedDiagnostics = new[]
        {
            new DiagnosticResult(ServerToClientAnalyzer.ServerToClientReturnTypeRule)
                .WithLocation(0)
                .WithArguments("GetMessages", "IServerToClient", "System.Threading.Tasks.Task<System.Collections.Generic.List<string>>"),
            new DiagnosticResult(ServerToClientAnalyzer.ServerToClientReturnTypeRule)
                .WithLocation(1)
                .WithArguments("GetData", "IServerToClient", "System.Threading.Tasks.Task<System.Collections.Generic.Dictionary<int, string>>")
        };
