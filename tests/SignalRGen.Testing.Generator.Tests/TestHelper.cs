    ...
    internal static Task Verify(string source, bool assertCacheability = true, DictionaryAnalyzerConfigOptions? analyzerOptions = null)
    {
        ...
        var references = AppDomain.CurrentDomain.GetAssemblies()
            ...
            [
                ...
                MetadataReference.CreateFromFile(typeof(GenerateFakeForHubClientAttribute).Assembly.Location),
            ]);
        ...
        var generator = new FakeSignalRClientGenerator().AsSourceGenerator();
